...
My computer crashed and didn't save any of the work so I had to redo the belt. Then I modelled a zip tie to show how the motor will be fixed to the 3D printed parts and finished off by adding the PCB mounted on the Arduino UNO R3. I had to add all the CAD files onto github as a zip folder to compress them as github only has a 25mb file limit.
